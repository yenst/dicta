...
QStringList candidates(const QString &name)
{
    static const QHash<QString, QStringList> aliases {
        ...
        {QStringLiteral("branch"), {QStringLiteral("vcs-branch-symbolic"), QStringLiteral("vcs-branch")}},
        ...
        {QStringLiteral("appearance"), {QStringLiteral("preferences-desktop-appearance-symbolic"), QStringLiteral("applications-graphics-symbolic")}},
        {QStringLiteral("connections"), {QStringLiteral("network-wired-symbolic"), QStringLiteral("network-wired")}},
        {QStringLiteral("shortcuts"), {QStringLiteral("preferences-desktop-keyboard-shortcuts-symbolic"), QStringLiteral("input-keyboard-symbolic")}},
        {QStringLiteral("transcription"), {QStringLiteral("audio-input-microphone-symbolic"), QStringLiteral("audio-input-microphone")}},
        {QStringLiteral("storage"), {QStringLiteral("drive-harddisk-symbolic"), QStringLiteral("drive-harddisk")}},
...
QString fallbackAsset(const QString &name)
{
    static const QHash<QString, QString> assets {
        ...
        {QStringLiteral("branch"), QStringLiteral("/usr/share/icons/breeze/actions/24/vcs-branch.svg")},
        ...
        {QStringLiteral("appearance"), QStringLiteral("/usr/share/icons/Adwaita/symbolic/legacy/preferences-desktop-appearance-symbolic.svg")},
        {QStringLiteral("connections"), QStringLiteral("/usr/share/icons/Adwaita/symbolic/devices/network-wired-symbolic.svg")},
        {QStringLiteral("shortcuts"), QStringLiteral("/usr/share/icons/Adwaita/symbolic/legacy/preferences-desktop-keyboard-shortcuts-symbolic.svg")},
        {QStringLiteral("transcription"), QStringLiteral("/usr/share/icons/Adwaita/symbolic/devices/audio-input-microphone-symbolic.svg")},
        {QStringLiteral("storage"), QStringLiteral("/usr/share/icons/Adwaita/symbolic/devices/drive-harddisk-symbolic.svg")},
